...
import 'package:gc_reminder/domain/models/map/map_model.dart' as _i29;
...
class ConfirmationCodeRoute extends _i27.PageRouteInfo<void> {
  const ConfirmationCodeRoute({List<_i27.PageRouteInfo>? children})
...
class EcommerceBagRoute extends _i27.PageRouteInfo<void> {
  const EcommerceBagRoute({List<_i27.PageRouteInfo>? children})
...
class EcommerceCheckoutRoute extends _i27.PageRouteInfo<void> {
  const EcommerceCheckoutRoute({List<_i27.PageRouteInfo>? children})
...
class EcommerceProductDetailRoute extends _i27.PageRouteInfo<void> {
  const EcommerceProductDetailRoute({List<_i27.PageRouteInfo>? children})
...
/// generated route for
/// [_i7.EcommerceScreen]
class EcommerceRoute extends _i27.PageRouteInfo<void> {
  const EcommerceRoute({List<_i27.PageRouteInfo>? children})
...
class EmptyStateRoute extends _i27.PageRouteInfo<void> {
  const EmptyStateRoute({List<_i27.PageRouteInfo>? children})
...
/// generated route for
/// [_i9.EventsScreen]
class EventsRoute extends _i27.PageRouteInfo<void> {
  const EventsRoute({List<_i27.PageRouteInfo>? children})
...
class FinanceOverviewRoute extends _i27.PageRouteInfo<void> {
  const FinanceOverviewRoute({List<_i27.PageRouteInfo>? children})
...
class OnboardingInitRoute extends _i27.PageRouteInfo<void> {
  const OnboardingInitRoute({List<_i27.PageRouteInfo>? children})
...
class OnboardingPersonalizeRoute extends _i27.PageRouteInfo<void> {
  const OnboardingPersonalizeRoute({List<_i27.PageRouteInfo>? children})
...
class ReminderListRoute extends _i27.PageRouteInfo<void> {
  const ReminderListRoute({List<_i27.PageRouteInfo>? children})
...
class SearchFilterRoute extends _i27.PageRouteInfo<void> {
  const SearchFilterRoute({List<_i27.PageRouteInfo>? children})
...
class SelectLocationRoute extends _i27.PageRouteInfo<SelectLocationRouteArgs> {
  SelectLocationRoute({
    _i28.Key? key,
    List<_i29.MapMarkerModel> markers = const [],
    List<_i27.PageRouteInfo>? children,
  }) : super(
...
class SelectLocationRouteArgs {
  ...
  final List<_i29.MapMarkerModel> markers;
  ...
  bool operator ==(Object other) {
    ...
    return key == other.key &&
        const _i30.ListEquality<_i29.MapMarkerModel>().equals(
          markers,
          other.markers,
        );
  }
  ...
  int get hashCode =>
      key.hashCode ^
      const _i30.ListEquality<_i29.MapMarkerModel>().hash(markers);
}
...
class SubscriptionPlansRoute extends _i27.PageRouteInfo<void> {
  const SubscriptionPlansRoute({List<_i27.PageRouteInfo>? children})
