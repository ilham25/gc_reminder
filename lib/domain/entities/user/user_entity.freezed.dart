...
class _UserEntity implements UserEntity {
  const _UserEntity({@JsonKey(name: 'id') this.id, @JsonKey(name: 'email') this.email, @JsonKey(name: 'first_name') this.firstName, @JsonKey(name: 'last_name') this.lastName, @JsonKey(name: 'avatar') this.avatar});
